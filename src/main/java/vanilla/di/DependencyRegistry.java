...
public class DependencyRegistry {
    ...
    public void registerDependency(Class cls){
        try {
            ...
            System.out.println("vanilla.di.annotations.Vanilla Added new Instance of: "+dependency.toString());
        } catch (Exception e) {
    ...
    public <T> T getDependency(Class<T> interfaceType) {
        System.out.println("vanilla.di.annotations.Vanilla getting Dependency for Interface Type: "+interfaceType);
    ...
    public void injectDependencies(Object object) {
        System.out.println("vanilla.di.annotations.Vanilla Injecting Dependency on:"+ object.getClass());
        Class<?> cls = object.getClass();
        Field[] fields = cls.getDeclaredFields();
        System.out.println("vanilla.di.annotations.Vanilla Found Fields: "+fields);
        for (Field field: fields) {
            for (Annotation a: field.getAnnotations()) {
                System.out.println("vanilla.di.annotations.Vanilla Found Annotation: "+a.annotationType());
            }

            if(field.getAnnotation(VanillaAutoInject.class) == null) continue;
            Class<?> fieldType = field.getType();
            System.out.println("vanilla.di.annotations.Vanilla Injecting Dependency of Type:"+ fieldType);
    ...
    public void resolveDependencies() {
        System.out.println("vanilla.di.annotations.Vanilla Resolving dependencies");
